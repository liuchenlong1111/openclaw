...
Alternative ARK endpoint format
"""
import os
import sys
import json
...
# - ARK_ENDPOINT_ID: Model endpoint ID
...
# For ARK, the endpoint is:
# https://ark.cn-beijing.volces.com/api/v3/chat/completions
# The model field is: endpoint_id
...
def create_video_task_ark(
    ...
    if not ARK_API_KEY:
        print("ERROR: ARK_API_KEY environment variable is required", file=sys.stderr)
        sys.exit(1)
...
if __name__ == "__main__":
    import argparse
    parser = argparse.ArgumentParser(description="Generate video with Doubao Seedance (Volcengine ARK format v2)")
